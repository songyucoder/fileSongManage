...
<template>
  <div class="flex row">
      ...
      <div class="flex justify-between w-100% items-center mt-5">
        ...
        <div class="flex row items-center">
          ...
          <div @click="exchangeRowEvent()"
            ...
            <Icon :size="20" v-else icon="material-symbols:align-justify-stretch"
          /></div>
        </div>
      </div>
      <!-- 文件类型 -->
    ...
    <el-dialog class="pt-5 pl-5 pr-5" v-model="is_CutOperate" title=" 裁剪" width="40%" top="5%">
