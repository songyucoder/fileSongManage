...
<template>
  <div class="flex" style="flex-direction: column">
    ...
    <div
      class="h-45 mt-3 flex items-center"
      :style="{ 'background-color': is_dark ? '#000' : '#f0f0f0' }"
      style="border-radius: 1px; flex-direction: column; justify-content: center"
      @dragenter="dragEnter"
      @dragleave="dragLeave"
      @dragover="dragOver"
      @drop="dropFile"
    >
      <div class="w-10 h-10 ml-1 flex"
        ><svg
          style="color: #105cfb"
    ...
    <div class="flex" style="flex-wrap: wrap">
      <div class="p-2 ml-1" v-for="(item, index) in files_Arr" :key="item + index">
        <div
          class="flex items-center"
          style="width: 150px; height: 120px; justify-content: center"
          :style="{ 'background-color': is_dark ? '#000' : '#f0f0f0' }"
        >
          <div class="flex">
            <img
            ...
            <div
              class="flex items-center"
              style="width: 150px; height: 120px; flex-direction: column; justify-content: center"
              v-else
            >
          ...
          <div
            style="position: absolute; z-index: 1; margin-top: -110px; margin-left: 150px"
            class="w-5 h-5"
